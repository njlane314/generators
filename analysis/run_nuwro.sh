...
generation_fluxfile="${generation_fluxfile:-${reweight_fluxfile:-$(ana_flux_dat "${repo_root}" "${beam_mode}" "${beam_species}")}}"
...

{
  ...
  printf '# generation_flux_mode = %s\n' "${generation_flux_mode}"
