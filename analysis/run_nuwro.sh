...
ana_check_files "${base_card}" "${reweight_fluxfile}"
...
{
  printf '\n################################################################################\n'
  printf '# ana flat Enu proposal and generator-variation override\n'
  printf '################################################################################\n\n'
  ...
  printf '# reweight_flux_file = %s\n' "${reweight_fluxfile}"
  printf '# reweight_flux_integral_0_10gev = %s\n\n' "${reweight_flux_integral}"
