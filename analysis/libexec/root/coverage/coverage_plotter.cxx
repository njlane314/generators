...
int coverage_colour(size_t index)
{
    const int colours[] = {
...
private:
                                ...
                                const TString& title)
    {
        ...
        for (size_t sample_index = 0; sample_index < hists.size(); ++sample_index) {
            const int colour = coverage_colour(sample_index);
        ...
        for (size_t sample_index = 0; sample_index < labels.size(); ++sample_index) {
            TLine* line = new TLine();
            line->SetLineColor(coverage_colour(sample_index));
            line->SetLineStyle(1);
            line->SetLineWidth(3);
