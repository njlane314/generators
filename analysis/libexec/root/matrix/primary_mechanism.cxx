...
)
{
    ...
    write_row(
        ...
        selected, selected.weight, "inclusive fiducial Lambda topology inside the analysis energy window"
    );
...
)
{
    ...
    label(h_cutflow.GetXaxis(), {
        "energy_window", "final_Lambda", "visible_p_pi", "flat_proxy", "selected_topology",
