...
FHC/RHC are compared using the matching NuMI flux histograms over the flat 0-10 GeV proposal.
EOF
  exit 1
fi
...
flux_file="${5:-example/numi/flux/microboone_numi_flux_5mev.root}"
flux_floor="${6:-0.0}"
proposal_emin="${7:-0.0}"
