...
FLUX_FILE defaults to example/numi/flux/microboone_numi_flux_5mev.root.
PROPOSAL_EMIN/PROPOSAL_EMAX default to the flat 0-10 GeV proposal.
...
flux_file="${3:-example/numi/flux/microboone_numi_flux_5mev.root}"
flux_floor="${4:-0.0}"
proposal_emin="${5:-0.0}"
